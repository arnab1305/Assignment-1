var data = [
  {
    ...
    name: "India News",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVzV2rCOyG7lOPs7XPxQ7kAUs-CigAI7LkCw&usqp=CAU",
  },
  {
    category: "News Videos",
    name: "China News",
  ...
  },
  {
    ...
    name: "Hindi Song",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSYVAMabEAzGvvl2MAMIubmmqxNBqdLu35Xg&usqp=CAU",
  },
  {
    category: "Songs",
    name: "English Song",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBgnPL5QK2zKsoy0hsKOOlwSQz1Sc3mXxWaQ&usqp=CAU",
  },
  {
    category: "Songs",
    name: "Telugu Song",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStz4YhDJwISi4IbUsBK2NR5C1SpVh3iziPuw&usqp=CAU",
  },
  {
    category: "Animals",
    name: "Dog",
...
sessionStorage.setItem("displayData", JSON.stringify(data));
sessionStorage.setItem("copyDisplayData", JSON.stringify(data));
